...
{
    public function __construct(ManagerRegistry $registry,private Connection $databaseConnection)
    {
    ...
    public function removeByEmail(string $userIdentifier)
    {
        $this->databaseConnection->delete('refresh_tokens',['username'=>$userIdentifier]);
    }
